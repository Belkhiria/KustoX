...
| order by TotalEvents desc`,
                expectedRows: -1, // Variable number of rows based on event types
...
| take 10`,
                expectedRows: 10, // Should be limited by take 10
...
| project StartTime, EventType, State`,
    ...
    public getTests(): TestResult[] {
        return this.testResults;
    }

    public async runTest(testIndex: number, actualResult: any): Promise<boolean> {
    ...
    private dataMatches(actual: any[][], expected: any[][]): boolean {
    ...
    public generateTestReport(results: boolean[]): string {

...
class MockDataGenerator {
    ...
    static generateTableData(rowCount = 100) {
        const columns = [
            'TIMESTAMP',
            'ClusterName',
            'NodeRole',
    ...
    static generateTimeSeriesData(rowCount = 50) {
    ...
    static generateSecurityData(rowCount = 75) {
        const columns = [
            'TIMESTAMP',
            'SourceIP',
            'DestinationIP',
    ...
    static generateRandomData(rowCount = 100, columnCount = 10) {
        const columns = [];

...
exports.checkForTruncation = exports.formatCellValue = exports.processKustoResponse = void 0;
    ...
    try {
        ...
        if (primaryTable._rows && Array.isArray(primaryTable._rows)) {
            for (const row of primaryTable._rows) {
                rows.push(row.map((cell) => formatCellValue(cell)));
            }
        }
        else {
...
exports.processKustoResponse = processKustoResponse;
...
exports.checkForTruncation = checkForTruncation;
